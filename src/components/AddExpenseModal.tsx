...
export default function AddExpenseModal({ participants, initialExpense, onSave, onClose, customCategories, onAddCustomCategory }: AddExpenseModalProps) {
  ...
  async function handleSubmit() {
    ...
    onSave({
      ...
      exchangeRate: isForeign ? Number(finalRate) : undefined,
      exchange_rate: isForeign ? Number(finalRate) : undefined,
      customExchangeRate: isForeign && useCustomRate ? Number(finalRate) : undefined,
      custom_exchange_rate: isForeign && useCustomRate ? Number(finalRate) : undefined,
